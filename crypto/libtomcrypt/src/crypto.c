...
#if defined(NOT_IMPLEMENTED) //joao add this to not include unecessary code to run BW
					    ...
					    size_t key_size_bits)
{
	...
	//if (res == TEE_ERROR_NOT_IMPLEMENTED)
		res = crypto_asym_alloc_ecc_keypair(key, key_type, key_size_bits);
...
#if defined(NOT_IMPLEMENTED) //joao add this
